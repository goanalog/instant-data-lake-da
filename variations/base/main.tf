...
# --------- COS instance (Lite) + regional bucket ----------
...
# Writer creds for app (HMAC for S3 API)
...
# --------- Upload sample CSVs from local repo ----------
locals {
...
# --------- ICR host & region mapping (CE region -> ICR) ----------
locals {
  # Host by region (pull/push)
  icr_host_by_region = {
    "us-south" = "us.icr.io"
    "us-east"  = "us.icr.io"
    "eu-de"    = "de.icr.io"
  ...
  # Registry region code for ibm_cr_namespace (not host)
...
# --------- Registry push secret for CE Build ----------
...
# --------- Build image from local helper-app/ (no GitHub fetch) ----------
...
# --------- CE App using freshly built image ----------
