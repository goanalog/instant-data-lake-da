...
output "5_Automate_Data_Ingestion_URL" {
  description = "Click this link to open App Connect and build no-code data pipelines."
  value       = "[https://cloud.ibm.com/services/appconnect/$](https://cloud.ibm.com/services/appconnect/$){ibm_resource_instance.appconnect_instance.guid}/launch"
}